        ...
        switch (data.getInt(0)) {
          case 1:
            try {
              ...
              if (mainActivity != null) {
                BaseApplication.toast(mainActivity, R.string.failed_cloud_api_key);
              } else {
                cancel(true);
              }
              return false;
          ...
          case 2:
            ...
            try {
              ...
              final MainActivity mainActivity = this.mainActivity.get();
              if (mainActivity != null) {
                BaseApplication.toast(mainActivity, R.string.cloud_error_plugin);
              ...
              final MainActivity mainActivity = this.mainActivity.get();
              if (mainActivity != null) {
                BaseApplication.toast(mainActivity, R.string.cloud_fail_authenticate);
                mainActivity.deleteConnection(OpenMode.GDRIVE);
              } else {
                cancel(true);
              }
              ...
              final MainActivity mainActivity = this.mainActivity.get();
              if (mainActivity != null) {
                BaseApplication.toast(mainActivity, R.string.failed_cloud_new_connection);
                mainActivity.deleteConnection(OpenMode.GDRIVE);
              } else {
                cancel(true);
              }
