...
public class PemToKeyPairTask extends AsyncTask<Void, IOException, KeyPair> {
  ...
  protected KeyPair doInBackground(Void... voids) {
    while (true) {
      ...
      if (this.passwordFinder != null) {
        this.errorMessage = BaseApplication.getInstance().getString(R.string.ssh_key_invalid_passphrase);
      }
  ...
  protected void onProgressUpdate(IOException... values) {
    ...
    MaterialDialog.Builder builder =
        new MaterialDialog.Builder(BaseApplication.getInstance().getMainActivityContext());
    View dialogLayout =
        View.inflate(
            BaseApplication.getInstance().getMainActivityContext(), R.layout.dialog_singleedittext, null);
