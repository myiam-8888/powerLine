    ...
    if (result.exception != null) {
      if (SocketException.class.isAssignableFrom(result.exception.getClass())
        ...
        if (DisconnectReason.HOST_KEY_NOT_VERIFIABLE.equals(disconnectReason)) {
          new AlertDialog.Builder(BaseApplication.getInstance().getMainActivityContext())
        ...
        Toast.makeText(
                BaseApplication.getInstance(), R.string.ssh_authentication_failure_key, Toast.LENGTH_LONG)
            .show();
      }
    }
  }
