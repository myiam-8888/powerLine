...
public class UtilsHandler {
  ...
  public void updateSsh(
    ...
    BaseApplication.runInBackground(() -> utilitiesDatabase.sftpEntryDao().update(entry));
  }
  ...
  public void renameSMB(String oldName, String oldPath, String newName, String newPath) {
    try {
      oldPath = SmbUtil.getSmbEncryptedPath(BaseApplication.getInstance(), oldPath);
      newPath = SmbUtil.getSmbEncryptedPath(BaseApplication.getInstance(), newPath);
    } catch (GeneralSecurityException | IOException e) {
