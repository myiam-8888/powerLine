...
public class EncryptedStringTypeConverter {
  ...
  public static StringWrapper toPassword(String encryptedStringEntryInDb) {
    try {
      return new StringWrapper(
          CryptUtil.decryptPassword(BaseApplication.getInstance(), encryptedStringEntryInDb));
    } catch (Exception e) {
  ...
  public static String fromPassword(StringWrapper unencryptedPasswordString) {
    try {
      return CryptUtil.encryptPassword(BaseApplication.getInstance(), unencryptedPasswordString.value);
    } catch (Exception e) {
