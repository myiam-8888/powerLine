...
import com.inspection.powerline.ShowPhotoActivity;
...
public class FileUtils {
  ...
  public static long folderSize(HybridFile directory, OnProgressUpdate<Long> updateState) {
    ...
    else return directory.folderSize(BaseApplication.getInstance());
  }
              ...
              switch (i) {
                ...
                case 1:
                  intent.setDataAndType(uri, "image/*");
                    intent = new Intent(c, ShowPhotoActivity.class);
                    intent.putExtra(
                            "path",
                            uri.getPath()
                                    .substring(
  ...
  public static void openFile(final File f, final MainActivity m, SharedPreferences sharedPrefs) {
    ...
    if (f.getName().toLowerCase().endsWith(".apk")) {
      ...
      m.startActivity(intent);
        ...
        Intent intent = new Intent(m, ShowPhotoActivity.class);
        intent.putExtra("path", f.getPath());
        m.startActivity(intent);
