...
public class BasicActivity extends AppCompatActivity {
  ...
  public ColorPreferenceHelper getColorPreference() {
    return getBaseApplication().getUtilsProvider().getColorPreference();
  }

  public AppTheme getAppTheme() {
    return getBaseApplication().getUtilsProvider().getAppTheme();
  }

  public UtilitiesProvider getUtilsProvider() {
    return getBaseApplication().getUtilsProvider();
  }
}
