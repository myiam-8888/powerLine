...
//    }
  ...
  private void setNavViewDimension(CustomNavigationView navView) {
    int screenWidth = BaseApplication.getInstance().getScreenUtils().getScreenWidthInDp();
    int desiredWidthInDp = screenWidth - ScreenUtils.TOOLBAR_HEIGHT_IN_DP;
    int desiredWidthInPx = BaseApplication.getInstance().getScreenUtils().convertDbToPx(desiredWidthInDp);
