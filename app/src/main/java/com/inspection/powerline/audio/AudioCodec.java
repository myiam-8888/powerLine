package com.inspection.powerline.audio;
...
//                    format.setInteger(MediaFormat.KEY_MAX_INPUT_SIZE, 200 * 1024);
        ...
        LogUtils.e("buffers:" + decodeInputBuffers.length);
    }
    ...
    private void initAACMediaEncode() {
        ...
        if (mediaEncode == null) {
            LogUtils.e(TAG, "create mediaEncode failed");
            return;
        }
        mediaEncode.start();
    ...
    private byte[] getPCMData() {
        synchronized (AudioCodec.class) {//记得加锁
            LogUtils.e("getPCM:"+chunkPCMDataContainer.size());
...
//                showLog("outPacketSize:" + outPacketSize + " encodeOutBufferRemain:" + outputBuffer.remaining());
    ...
    private class EncodeRunnable implements Runnable {
        ...
        public void run() {
            ...
            LogUtils.e("size:"+fileTotalSize+" decodeSize:"+decodeSize+"time:"+(System.currentTimeMillis()-t));
        }
    }
