...
public class AndPermission {
     ...
     * Some privileges permanently disabled, may need to set up in the execute.
     *
     * @param fragment          {@link android.support.v4.app}.
     * @param deniedPermissions one or more permissions.
     * @return true, other wise is false.
     */
    ...
    public static
    @NonNull
    SettingDialog defaultSettingDialog(@NonNull Activity activity, int requestCode,DisplayMetrics dm) {
        return new SettingDialog(activity, new SettingExecutor(new AppActivityTarget(activity), requestCode),dm);
    }
    ...
    public static
    @NonNull
    SettingDialog defaultSettingDialog(@NonNull Fragment fragment, int requestCode,DisplayMetrics dm) {
        return new SettingDialog(fragment.getActivity(), new SettingExecutor(new SupportFragmentTarget(fragment), requestCode),dm);
    }
    ...
    public static
    @NonNull
    SettingDialog defaultSettingDialog(@NonNull android.app.Fragment fragment, int requestCode,DisplayMetrics dm) {
        return new SettingDialog(fragment.getActivity(), new SettingExecutor(new AppFragmentTarget(fragment), requestCode),dm);
    }
    ...
    public static
    @NonNull
    SettingDialog defaultSettingDialog(@NonNull Context context,DisplayMetrics dm) {
        return new SettingDialog(context, new SettingExecutor(new ContextTarget(context), 0),dm);
    }
