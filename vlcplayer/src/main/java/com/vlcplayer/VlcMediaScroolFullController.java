...
public class VlcMediaScroolFullController implements VlcScroolFullControllerView.MediaPlayerControl, MediaListenerEvent {
    private MediaPlayerControl mediaPlayer;
    private VlcScroolFullControllerView controller;
    private FullScreenListener fullScreenListener;

    public VlcMediaScroolFullController(final VlcScroolFullControllerView controller,
