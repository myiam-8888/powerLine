...
public class
VlcVideoView extends TextureView implements MediaPlayerControl, TextureView.SurfaceTextureListener, VideoSizeChange {
    ...
    public interface VlcVideoViewOnComplete {
        void oncomplete();
    }

    private VlcVideoViewOnComplete mVlcVideoViewOnComplete;


    public void setVlcVideoViewOnComplete(VlcVideoViewOnComplete mVlcVideoViewOnComplete) {

        this.mVlcVideoViewOnComplete = mVlcVideoViewOnComplete;
    }
    ...
    private void init(Context context) {
        ...
        videoMediaLogic.setVlcVideoPlayerOnComplete(new VlcVideoPlayer.vlcVideoPlayerOnComplete() {
            @Override
            public void onComplete() {
                Log.i(tag, "onComplete");

                if(null!=mVlcVideoViewOnComplete){
                    mVlcVideoViewOnComplete.oncomplete();
                }
